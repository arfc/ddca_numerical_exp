...
Three types of algorithms will be developed: non-optimizing, deterministic-optimizing and stochastic-optimizing. This report will focus on the non-optimizing algorithm. 
...
\section{Method}
This report lists capability requirements of the new \Cyclus \texttt{institute}
...
\section{Scope}
Expectations for the non-optimizing algorithm are different from the deterministic-optimizing and stochastic-optimizing. In this section, the scope for the non-optimizing algorithm is specified. 
