...
The once-through nuclear fuel cycle with four stages
is used for the numerical test. This cycle is chosen
due to its simplicity. It consists of \texttt{Source},
 \texttt{Enrichment}, \texttt{Reactor} and \texttt{Sink},
 which are all \texttt{Cycamore} archetypes. The material
 flow between facilities is shown in figure \ref{diag:once}.

However, it should be clear that the goal is to
be able to deploy any agents in \Cyclus. 
...
The user defines the prototypes  and reactor deployment. 
