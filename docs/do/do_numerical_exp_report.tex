...
% wording
The goal of test A-dep-3 is to determine whether a source facility is deployed when the lifetime of another is ending to meet the upcoming loss of power supply when there multiple source facilities decommissioning and deploying at different times. 
