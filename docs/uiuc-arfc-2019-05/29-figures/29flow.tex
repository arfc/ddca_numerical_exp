...
\begin{tikzpicture}[node distance=3cm,
 ...
 \draw[->]					(source)++(1.25,0.)-- node[midway] {natural-U} ++(2.3,0.)--  ++(0.,-1.5);
\draw[->]					(lwrrepro)++(2.15,6.)-- ++(0.,1.2)-- ++(5.8,0.)-- ++(0.,-.7);

 \draw[->]					(lwrrepro)++(1.6,0.)-- ++(0.55,0.)-- node[midway] {U/Pu} ++(0.,6.)--
  ++(0.8,0.);
 \draw[->]					(lwrrepro)++(2.15,6.)-- ++(0.,1.2)-- ++(5.8,0.)-- ++(0.,-.7);

 \draw[->]					(frrepro)++(1.5,0.)-- ++(0.2,0.)-- node[midway] {U/Pu} ++(0.,6.)--
++(-0.45,0.);
 \draw[->]					(frrepro)++(1.7,6.)-- ++(0.,1.7)-- node[midway] {U/Pu} ++(3.5,0.)-- ++(0.,-1.2);

 \draw[->]					(moxrepro)++(-1.6,0.)-- ++(-0.2,0.)-- node[midway] {U/Pu} ++(0.,6.)--
++(0.55,0.);  
