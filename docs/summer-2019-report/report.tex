...
This section focuses on EG01-EG23 for analyzing the dependency of the undersupply on the buffer size. Table \ref{tab:buff_size} shows number of time steps of undersupply and the cumulative undersupply for different buffer sizes using some of the prediction methods.
...
\begin{table*}[]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|}
		\hline
		& \multicolumn{6}{c|}{Buffer Size} \\ \hline
		& \multicolumn{2}{c|}{0}&\multicolumn{2}{c|}{0}&\multicolumn{2}{c|}{0} \\ \hline
		Algorithm & \shortstack{No. of time steps\\of undersupply}  & 
		\shortstack{Cumulative\\Undersupply[GW]}  & \shortstack{No. of time steps\\of undersupply}  & 
		\shortstack{Cumulative\\Undersupply[GW]}  &\shortstack{No. of time steps\\of undersupply}  & 
		\shortstack{Cumulative\\Undersupply[GW]}  \\ \hline
		MA       		&		&		& 	20 	& 20.0  &  	&   \\ \hline
		ARMA      		& 		&		&	18 	&  7.7  &  	&  	\\ \hline
		POLY      		& 		&		& 	1 	&  0.3 	&  	&	\\ \hline
		EXP\_SMOOTHING 	&		&		& 	20 	& 11.0 	& 	& 	\\ \hline
		FFT       		&		&		& 	2 	& 60.3 	&  	&	\\ \hline
	\end{tabular}
\end{table*}
