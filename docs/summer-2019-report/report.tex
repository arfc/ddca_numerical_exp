...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\vfill\vfill
	\includegraphics[width=0.5\textwidth]{figures/logo.png} % Include a department/university logo - this will require the graphicx package
	...
	{\large ARFC-NPRE-19-00}\\ % Report number
	...
	{\huge\bfseries Cycamore Demand Driven Capabilities}\\[0.4cm] % Title of your document
	
	{\LARGE\textit{SUMMER 2019 Report}}\\[0.4cm] % Subtitle
	\HRule\\[1.5cm]
